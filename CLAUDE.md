...
- **`raw/`** — fuentes crudas e inmutables: transcripciones de conversaciones exportadas tal cual, documentos, capturas. Se lee, nunca se edita ni se reescribe in-place. Subcarpetas por tipo de fuente: `raw/transcripciones/` (exportación completa vía Claude.ai), `raw/clippings/` (capturas parciales con web clipper).
